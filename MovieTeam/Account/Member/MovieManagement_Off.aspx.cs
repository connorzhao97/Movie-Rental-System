...
{
    public partial class MovieManagement_Off : System.Web.UI.Page
    {
        #region==全局对象==
        BLL.Movie bllMovie;
        ...
        {
            GridView1.DataSource = bllMovie.MoviesView_Off();
            GridView1.DataBind();
        }
        #endregion
        ...
        protected void GridView1_RowEditing(object sender, GridViewEditEventArgs e)
        {
            ...
            //在点击编辑之前设置按钮不可用
            FileUpload fUpload = (FileUpload)GridView1.Rows[GridView1.EditIndex].Cells[13].FindControl("FileUpload2");
