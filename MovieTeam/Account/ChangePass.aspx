...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="new_phone center_div">
        ...
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
        <input runat="server" ID="TextBox4" style="border: 1px solid deepskyblue; width: 350px; height: 40px; border-radius:5px;border-color:lightslategrey" type="text" name="upass" placeholder="原密码" class="user_id_password mar_b_40px">
        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TextBox4" ErrorMessage="用户名不能为空" ForeColor="Red">*原密码不能为空！</asp:RequiredFieldValidator>
        </div>
        <br />
